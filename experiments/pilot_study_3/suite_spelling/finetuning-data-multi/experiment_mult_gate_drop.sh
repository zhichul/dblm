...
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/spelling/colm_finetuned_seq2seq_models_with_inference_vary_data_multi_mult_gate_post_scale_gate_random_init_dropout/${SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${N}/${MULTI_LAMBDA}
mkdir -p ${OUT_DIR}
...
python3 ../../suite/finetuning/finetune_encoder_decoder.py \
    ...
    --project ${PROJ} \
    --group ${GROUP} \
    --name Mult-Gate-Layer-${NLAYER}-${N}-${MULTI_LAMBDA}-Drop-1.0${NAME_INFERENCE}${DEMO} \
