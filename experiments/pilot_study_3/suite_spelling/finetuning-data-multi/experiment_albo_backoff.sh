...
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/spelling/colm_finetuned_seq2seq_models_with_inference_vary_data_multi_post_scale_gate_random_init/${SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${N}/${MULTI_LAMBDA}
mkdir -p ${OUT_DIR}
