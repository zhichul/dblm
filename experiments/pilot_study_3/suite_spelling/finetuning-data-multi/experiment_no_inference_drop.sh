...
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/spelling/colm_finetuned_seq2seq_models_vary_data_multi_random_init_dropout/${SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${N}/${MULTI_LAMBDA}
mkdir -p ${OUT_DIR}
