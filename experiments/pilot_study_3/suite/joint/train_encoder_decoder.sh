...
for N in 100000
do
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/joint_seq2seq_models_with_inference/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${NHIDDEN}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/
mkdir -p ${OUT_DIR}
...
CUDA_VISIBLE_DEVICES=0 python3 train_encoder_decoder.py \
    ...
    --output_dir ${OUT_DIR} \
    --group joint \
    --name Nested-Oracle-${NLAYER}-${NHIDDEN}
done
done
done
done
