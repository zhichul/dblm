...
do
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/finetuned_decoder_models_vary_data_multi/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}_888/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/${N}/${MULTI_LAMBDA}
PRETRAINED_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/pretrained_decoder_models/42/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/64/64/1e-5/12_888/300000/checkpoint-300000/
mkdir -p ${OUT_DIR}
...
CUDA_VISIBLE_DEVICES=0 python3 ../finetuning/finetune_decoder.py \
    ...
    --name Regular-l12-h888-${N}-${MULTI_LAMBDA} \
    --first ${N} \
