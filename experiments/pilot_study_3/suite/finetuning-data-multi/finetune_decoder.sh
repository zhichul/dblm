...
do
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/finetuned_decoder_models_vary_data_multi/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/${N}/${MULTI_LAMBDA}
...
CUDA_VISIBLE_DEVICES=1 python3 ../finetuning/finetune_decoder.py \
    ...
    --name Regular-l12-${N}-${MULTI_LAMBDA} \
    --first ${N} \
