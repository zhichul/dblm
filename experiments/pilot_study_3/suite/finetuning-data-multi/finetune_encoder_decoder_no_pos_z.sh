...
do
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/finetuned_seq2seq_models_vary_data_multi_no_pos_z/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/${N}/${MULTI_LAMBDA}
PRETRAINED_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/pretrained_seq2seq_models_no_pos_z/42/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/64/64/1e-5/12/100000/checkpoint-100000/
mkdir -p ${OUT_DIR}
...
CUDA_VISIBLE_DEVICES=0 python3 ../finetuning/finetune_encoder_decoder.py \
    ...
    --no_inference \
    --name NPZ-No-Inference-${N}-${MULTI_LAMBDA} \
    --first ${N} \
