...
for N in 100000
do
for NOISE in 0.114 0.171 0.256 0.384 0.577 0.865
do
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/finetuned_seq2seq_models_with_uniform_noise/${NOISE}/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/
...
CUDA_VISIBLE_DEVICES=1 python3 ../finetuning/finetune_encoder_decoder.py \
