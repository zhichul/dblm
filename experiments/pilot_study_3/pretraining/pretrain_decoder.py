...
from dblm.experiments.pilot_study_3.utils import decoder_train_data_generator
...
def parse_args():
    ...
    parser.add_argument("--n_hidden", type=int, required=False, default=768)
...
def main():
    ...
    # load data
    seeding.seed(args.seed)
    train_data = decoder_train_data_generator(args.nvars, args.nvals, args.seq_len, args.n_branches, args.gpu_batch_size, args.x_model_seed)
