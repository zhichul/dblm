...
do
for NOISE in 0.5 # 0.03 0.1 0.3 0.9 #0.9 0.99 0.999 #0.05 0.17 0.5 # 0.001 0.003 0.01 0.03 0.1 0.3
do
for N in 1000 2500 5000 10000 25000 50000
do
for MULTI_LAMBDA in 0 0.001 0.01 0.1 1 10 100 1000
do
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/finetuned_seq2seq_models_with_inference_vary_data_multi_post_scale_gate_with_uniform_noise/${NOISE}/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/${N}/${MULTI_LAMBDA}/${NOISE}
...
CUDA_VISIBLE_DEVICES=0 python3 ../../suite/finetuning/finetune_encoder_decoder.py \
    ...
    --name MixUniform-${NOISE}-PSG-Nested-Oracle-${N}-${MULTI_LAMBDA} \
    --uniform_noise ${NOISE} \
    --post_scale_gate
