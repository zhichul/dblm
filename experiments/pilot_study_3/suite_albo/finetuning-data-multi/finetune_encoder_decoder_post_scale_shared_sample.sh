...
do
for K in 1000 #500 #10 100
do

OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/finetuned_seq2seq_models_with_inference_vary_data_multi_post_scale_gate_shared_sample/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/${N}/${MULTI_LAMBDA}/${K}
...
CUDA_VISIBLE_DEVICES=1 python3 ../../suite/finetuning/finetune_encoder_decoder.py \
    ...
    --name PSG-Nested-Sample${K}-${N}-${MULTI_LAMBDA} \
    --first ${N} \
