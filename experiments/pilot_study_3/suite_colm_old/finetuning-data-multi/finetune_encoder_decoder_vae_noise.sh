...
for NLAYER in 12
do
for TRAIN_STEPS in 3000
do
for SAMPLE_SEED in 42
do
for N in 5000 # 50000 #500 5000 50000 #100 250 500 1000 #2500 5000 10000 25000 50000
do
for MULTI_LAMBDA in 1 #1 100 # 0.001 0.01 10000 100000 #
do
for NOISE in 0.1 0.2 0.4
do 
OUT_DIR=/${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/colm_finetuned_seq2seq_models_vary_data_multi_vae_random_init_noise/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/${N}/${MULTI_LAMBDA}/${NOISE}/
...
CUDA_VISIBLE_DEVICES=0 python3 ../../suite/finetuning/finetune_encoder_decoder.py \
    ...
    --output_dir ${OUT_DIR} \
    --project colm \
    --group finetune-data-multi-2k-noise \
    --no_inference \
    --name Noise-${NOISE}-VAE-${N}-${MULTI_LAMBDA} \
    --first ${N} \
