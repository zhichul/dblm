...
do
for N in 500 5000 # 50000 #50000 #100 250 500 1000 #2500 5000 10000 25000 50000
do
for MULTI_LAMBDA in 0 #1 100 # 0.001 0.01 10000 100000 #
do
for NOISE in 0.1 0.2 # 0.4
do 
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/colm_finetuned_seq2seq_models_with_inference_vary_data_multi_mult_gate_post_scale_gate_random_init_noise/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/${N}/${MULTI_LAMBDA}
...
CUDA_VISIBLE_DEVICES=0 python3 ../../suite/finetuning/finetune_encoder_decoder.py \
    ...
    --name Noise-${NOISE}-PSG-Mult-Gate-${N}-${MULTI_LAMBDA} \
    --first ${N} \
