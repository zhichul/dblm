...
do
OUT_DIR=${BLU_ARTIFACTS2}/dblm/experiments/pilot_study_3/colm_finetuned_seq2seq_models_with_inference_vary_data_multi_mult_gate_post_scale_gate_random_init/${SEED}/${NVARS}/${NVALS}/${SEQ_LEN}/${NBRANCHES}/${X_SEED}/${BATCH_SIZE}/${GPU_BATCH_SIZE}/${LR}/${NLAYER}/${TRAIN_STEPS}/${ZSEED}/${MEAN}/${STD}/${N}/${MULTI_LAMBDA}
...
CUDA_VISIBLE_DEVICES=1 python3 ../../suite/finetuning/finetune_encoder_decoder.py \
    ...
    --name Random-Init-PSG-Mult-Gate-${N}-${MULTI_LAMBDA} \
    --first ${N} \
